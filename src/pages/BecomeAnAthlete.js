...
import RunningImage from '../img/starting-sprinter.jpg';

class BecomeAnAthlete extends PureComponent {
  render() {
    return (
      <div>
        <HeroImage url={RunningImage} />
        <PageContent>
          <Title>Werde ein Athlet</Title>
          <Section>
...
export default BecomeAnAthlete;
